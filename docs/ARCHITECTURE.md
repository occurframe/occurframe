...
- `xtask` exposes developer-only validation, migration, packing, manifest, determinism, runner-contract, adapter-smoke, and full-certification commands. It is not a public product CLI.
...
The reserved future public commands `explain`, `classify`, and especially
