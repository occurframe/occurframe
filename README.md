...
This repository contains Rust authority tooling, wire types, a supervised external-runner runtime, and the migrated Phase II adapters. The separate [`occurframe/corpus`](https://github.com/occurframe/corpus) repository owns the specification, schemas, registries, vectors, independent Python reference matcher, and historical evidence.
...
No recurrence evaluator, scheduler, public CLI, or engine crate exists here. External adapters invoke independently versioned recurrence engines and report what they observed; Occurframe contains and scores those observations. See [Architecture](docs/ARCHITECTURE.md), [Runner architecture](docs/RUNNER-ARCHITECTURE.md), and [Development](docs/DEVELOPMENT.md).
